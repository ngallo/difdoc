...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{idtz/cap-theorem.pdf}
    \caption{CAP Theorem}
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{idtz/cloud-architecture.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{idtz/current-model.pdf}
